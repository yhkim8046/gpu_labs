...
RUN CGO_ENABLED=0 GOOS=linux go build -trimpath -ldflags="-s -w -X github.com/gpu-lab/gpu-lab/internal/version.Version=${VERSION} -X github.com/gpu-lab/gpu-lab/internal/version.Commit=${COMMIT} -X github.com/gpu-lab/gpu-lab/internal/version.BuildDate=${BUILD_DATE}" -o /out/gpu-lab ./cmd/gpu-lab
